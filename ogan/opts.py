...
def embedding_opts(parser):
    ...
    group.add_argument('-position_encoding', action='store_false',help="""Use a sin to mark relative words positions. Necessary for non-RNN style models.""")
    group.add_argument('-pe_dropout', type=float, default=0.3,help="""Use a sin to mark relative words positions. Necessary for non-RNN style models.""")

    group = parser.add_argument_group('Model-Embedding Features')
    group.add_argument('-feat_merge', type=str, default='concat', choices=['concat', 'sum', 'mlp'], help="""Merge action for incorporating features embeddings. Options [concat|sum|mlp].""")
    group.add_argument('-feat_vec_size', type=int, default=-1, help="""If specified, feature embedding sizes will be set to this. Otherwise, feat_vec_exponent will be used.""")
    group.add_argument('-feat_vec_exponent', type=float, default=0.7, help="""If -feat_merge_size is not set, feature embedding sizes will be set to N^feat_vec_exponent where N is the number of values the feature takes.""")

def memory_opts(parser):
    """
    These options are passed to the construction of the encoder as memory input.
    It will be used in both discriminator and generator. (In Memory GAN Framework)
    """
    # Memory Options
    group = parser.add_argument_group('Memory- Encoder')
    group.add_argument('-memory_input_type', default='text',
                       help="""Type of source model to use. Allows
                       the system to incorporate non-text inputs.
                       Options are [text|img|audio].""")

    group.add_argument('-memory_model_type', type=str, default='rnn',
                       choices=['rnn', 'brnn', 'mean', 'transformer', 'cnn'],
                       help="""Type of encoder layer to use. Non-RNN layers
                       are experimental. Options are
                       [rnn|brnn|mean|transformer|cnn].""")

    group.add_argument('-memory_rnn_type', type=str, default='LSTM', choices=['LSTM', 'GRU'], help="""The gate type to use in the RNNs""")
    group.add_argument('-memory_rnn_size', type=int, default=500, help='Size of rnn hidden states')
    group.add_argument('-memory_rnn_layers', type=int, default=1, help='Number of layers in the lstm discriminator')


def discriminator_opts(parser):
    """
    These options are passed to the construction of the model.
    Be careful with these as they will be used during translation.
    """
    # Discriminator Options
    group = parser.add_argument_group('Discriminator- Encoder-Decoder')
    group.add_argument('-discriminator_type', default='text',
                       help="""Type of source model to use. Allows
                       the system to incorporate non-text inputs.
                       Options are [text|img|audio].""")

    group.add_argument('-discriminator_model_type', type=str, default='lstm', choices=['rnn', 'lstm', 'brnn', 'mean', 'transformer', 'cnn'])

    group.add_argument('-discriminator_rnn_type', type=str, default='LSTM', choices=['LSTM', 'GRU'], help="""The gate type to use in the RNNs""")
    group.add_argument('-discriminator_rnn_size', type=int, default=500, help='Size of rnn hidden states')
    group.add_argument('-discriminator_rnn_layers', type=int, default=1, help='Number of layers in the lstm discriminator')
    group.add_argument('-discriminator_dropout', type=float, default=0.3, help='Size of rnn hidden states')



def generator_opts(parser):
    """
    These options are passed to the construction of the model.
    Be careful with these as they will be used during translation.
    """
    # Generator Options
    group = parser.add_argument_group('Generator- Encoder-Decoder')
    group.add_argument('-generator_type', default='text',
                       help="""Type of source model to use. Allows
                       the system to incorporate non-text inputs.
                       Options are [text|img|audio].""")

    group.add_argument('-generator_model_type', type=str, default='lstm', choices=['rnn', 'lstm', 'brnn', 'mean', 'transformer', 'cnn'])

    group.add_argument('-generator_rnn_type', type=str, default='LSTM', choices=['LSTM', 'GRU'], help="""The gate type to use in the RNNs""")
    group.add_argument('-generator_rnn_size', type=int, default=500, help='Size of rnn hidden states')
    group.add_argument('-generator_rnn_layers', type=int, default=1, help='Number of layers in the lstm discriminator')
...
def preprocess_opts(parser):
    ...
    group.add_argument('-data_type', default="text_single_turn",
