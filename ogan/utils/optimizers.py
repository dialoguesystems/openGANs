...
from ogan.utils import use_gpu


def build_optim(models, opt, checkpoint):
    """ Build optimizer """
    ...
    parameter_values = []
    for model in models:
        parameter_values += [pv for pv in model.named_parameters()]
    optim.set_parameters(parameter_values)
